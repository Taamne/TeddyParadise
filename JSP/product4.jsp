            ...
            <div class="product_page">
                <div class="product_page-introduce">
                    <div class="product_page-intro-item">
                        <img src="./assets/img/product4.png" alt="" class="product_page-intro-img">
                    </div>
                    <div class="product_page-intro-item">
                        ...
                        <h2 class="product_page-intro-header">Gà vô tri Kichi Hihi</h2>
                        <div class="intro_line"></div>
                        <p class="product_intro-price">380.000₫</p>
                        <p class="product_page-intro-text">Gấu bông hình chú gà Kichi hài hước</p>
                        <label for="product_intro-color">Chọn màu tóc:</label>
                ...
                <div class="product_page-description">
                    ...
                    <div class="product_page-description-item">
                        <p>MÔ TẢ GÀ KICHI HIHI:</p>
                        <p>Có 2 màu tóc cho khách hàng thoải mái lựa chọn.</p>
                        <p>Trông vô tri.</p>
                    </div>
