            ...
            <div class="product_page">
                <div class="product_page-introduce">
                    <div class="product_page-intro-item">
                        <img src="./assets/img/product11.png" alt="" class="product_page-intro-img">
                    </div>
                    <div class="product_page-intro-item">
                        ...
                        <h2 class="product_page-intro-header">Khủng long Nisa baby</h2>
                        <div class="intro_line"></div>
                        <p class="product_intro-price">220.000₫</p>
                        <p class="product_page-intro-text">Bé khủng long Nisa baby cực kì đáng yêu</p>
                ...
                <div class="product_page-description">
                    ...
                    <div class="product_page-description-item">
                        <p>MÔ TẢ KHỦNG LONG NISA BABY:</p>
                        <p>Em khủng long má hồng ôm mềm mịn đẫy tay lắm lun. Ôm em đi ngủ hay để tựa là đủ thấy thư giãn sau một ngày dài.</p>
                        <p>Kích thước: 45cm.</p>
                        <p>Chất liệu: Nhung mềm mịn (cực an toàn với các em bé).</p>
                        <p>Công dụng: Ôm, tựa, gấu bông ôm đi ngủ, quà tặng đặc biệt...</p>
                    </div>
