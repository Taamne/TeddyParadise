            ...
            <div class="product_page">
                <div class="product_page-introduce">
                    <div class="product_page-intro-item">
                        <img src="./assets/img/product1.png" alt="" class="product_page-intro-img">
                    </div>
                    <div class="product_page-intro-item">
                        ...
                        <h2 class="product_page-intro-header">Gấu nhồi bông cho bé ôm ngủ đáng yêu</h2>
                        <div class="intro_line"></div>
                        <p class="product_intro-price">270.000₫</p>
                        <p class="product_page-intro-text">Gấu nhồi bông cho bé ôm ngủ, quà tặng...</p>
                ...
                <div class="product_page-description">
                    ...
                    <div class="product_page-description-item">
                        <p>MÔ TẢ GẤU NHỒI BÔNG CHO BÉ ÔM NGỦ ĐÁNG YÊU:</p>
                        <p>Thiết kế bắt mắt, chất liệu vải cao cấp.</p>
                        <p>An toàn cho trẻ.</p>
                    </div>
