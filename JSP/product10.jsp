            ...
            <div class="product_page">
                <div class="product_page-introduce">
                    <div class="product_page-intro-item">
                        <img src="./assets/img/product10.png" alt="" class="product_page-intro-img">
                    </div>
                    <div class="product_page-intro-item">
                        ...
                        <h2 class="product_page-intro-header">Mèo Lucifer mặt quạo</h2>
                        <div class="intro_line"></div>
                        <p class="product_intro-price">560.000₫</p>
                        <p class="product_page-intro-text">Gấu bông hình chú mèo Lucifer mặt quạo</p>
                        <!-- <label for="product_intro-color">Chọn màu sản phẩm:</label>
                ...
                <div class="product_page-description">
                    ...
                    <div class="product_page-description-item">
                        <p>MÔ TẢ MÈO LUCIFER MẶT QUẠO:</p>
                        <p>Ai đã từng xem bộ phim "Cô bé lọ lem" nổi tiếng của Disney chắc chắn sẽ biết em mèo Lucifer "xéo sắc" này rùi.</p>
                        <p>Chất liệu: Lông mềm mịn, bông gòn cao cấp.</p>
                        <p>Kích thước: 50x60cm rất bự rất bếu.</p>
                        <p>Công dụng: Ôm, gác, tựa lưng...</p>
                        <p>Thích hợp để: Sử dụng hàng ngày, trang trí nhà cửa, làm quà tặng sinh nhật, quà tặng các dịp đặc biệt,...</p>
                    </div>
