            ...
            <div class="product_page">
                <div class="product_page-introduce">
                    <div class="product_page-intro-item">
                        <img src="./assets/img/product8.png" alt="" class="product_page-intro-img">
                    </div>
                    <div class="product_page-intro-item">
                        ...
                        <h2 class="product_page-intro-header">Cặp đôi heo hồng Wedding Pig</h2>
                        <div class="intro_line"></div>
                        <p class="product_intro-price">260.000₫</p>
                        <p class="product_page-intro-text">Gấu bông hình cặp đôi Wedding Pig cực kì đáng yêu</p>
                ...
                <div class="product_page-description">
                    ...
                    <div class="product_page-description-item">
                        <p>MÔ TẢ CẶP ĐÔI HEO HỒNG WEDDING PIG:</p>
                        <p>Gồm 2 bé heo: Cô dâu + chú rể heo hồng và phụ kiện đi kèm.</p>
                        <p>Cực thích hợp làm quà tặng cặp đôi, quà cưới...</p>
                        <p>Chất liệu: Nỉ nhung cao cấp mềm mịn, cao cấp.</p>
                        <p>Kích thước: 22cm.</p>
                    </div>
