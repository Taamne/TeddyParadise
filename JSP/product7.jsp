            ...
            <div class="product_page">
                <div class="product_page-introduce">
                    <div class="product_page-intro-item">
                        <img src="./assets/img/product7.png" alt="" class="product_page-intro-img">
                    </div>
                    <div class="product_page-intro-item">
                        ...
                        <h2 class="product_page-intro-header">Gấu trúc trong ống tre Tori Panda</h2>
                        <div class="intro_line"></div>
                        <p class="product_intro-price">280.000₫</p>
                        <!-- <p class="product_page-intro-text">Bó hoa gấu tặng tốt nghiệp cấp 1,2,3, kỷ yếu, đại học,…</p>
                ...
                <div class="product_page-description">
                    ...
                    <div class="product_page-description-item">
                        <p>MÔ TẢ GẤU TRÚC TRONG ỐNG TRE TORI PANDA:</p>
                        <p>Chất liệu: Lông mềm mịn được nhồi bông gòn cao cấp.</p>
                        <p>Kích thước: 25cm.</p>
                        <p>Tính năng: Gấu ôm, gấu cầm tay, trang trí bàn học, bàn làm việc, quà tặng dịp đặc biệt (sinh nhật,...).</p>
                    </div>
