            ...
            <div class="product_page">
                <div class="product_page-introduce">
                    <div class="product_page-intro-item">
                        <img src="./assets/img/product5.png" alt="" class="product_page-intro-img">
                    </div>
                    <div class="product_page-intro-item">
                        ...
                        <h2 class="product_page-intro-header">Gấu bông Hải Ly Loopy Cosplay</h2>
                        <div class="intro_line"></div>
                        <p class="product_intro-price">320.000₫</p>
                        <p class="product_page-intro-text">Gấu bông Loopy hot trend Cosplay</p>
                ...
                <div class="product_page-description">
                    ...
                    <div class="product_page-description-item">
                        <p>MÔ TẢ GẤU BÔNG LOOPY COSPLAY:</p>
                        <p>Các bé hải ly Loopy cosplay dễ thương quá nè.</p>
                        <p>Chất liệu: Lông mềm mịn, nỉ nhung cao cấp.</p>
                        <p>Kích thước: 40cm</p>
                    </div>
