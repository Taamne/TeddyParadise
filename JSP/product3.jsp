            ...
            <div class="product_page">
                <div class="product_page-introduce">
                    <div class="product_page-intro-item">
                        <img src="./assets/img/product3.png" alt="" class="product_page-intro-img">
                    </div>
                    <div class="product_page-intro-item">
                        ...
                        <h2 class="product_page-intro-header">Kurumi ôm búp bê</h2>
                        <div class="intro_line"></div>
                        <p class="product_intro-price">280.000₫</p>
                        <p class="product_page-intro-text">Gấu bông hình Kurumi ôm búp bê siêu dễ thương, có sẵn 2 màu tím, hồng</p>
                ...
                <div class="product_page-description">
                    ...
                    <div class="product_page-description-item">
                        <p>MÔ TẢ KURUMI ÔM BÚP BÊ:</p>
                        <p>Gấu bông hình Kurumi dễ thương.</p>
                        <p>Cao: 34cm.</p>
                        <p>Chất liệu: Nỉ mềm mịn, nhồi bông cao cấp chống biến dạng.</p>
                    </div>
