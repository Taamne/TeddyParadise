            ...
            <div class="product_page">
                <div class="product_page-introduce">
                    <div class="product_page-intro-item">
                        <img src="./assets/img/product12.png" alt="" class="product_page-intro-img">
                    </div>
                    <div class="product_page-intro-item">
                        ...
                        <h2 class="product_page-intro-header">Gấu bông ủ tay kèm chăn Lotso cao cấp 3 in 1</h2>
                        <div class="intro_line"></div>
                        <p class="product_intro-price">430.000₫</p>
                        <p class="product_page-intro-text">Gấu bông Lotso có thể u tay, có kèm chăn bên trong</p>
                ...
                <div class="product_page-description">
                    ...
                    <div class="product_page-description-item">
                        <p>MÔ TẢ GẤU BÔNG LOTSO Ủ TAY KÈM CHĂN CAO CẤP 3 IN 1:</p>
                        <p>Gấu bông ủ tay kèm chăn Lotso siêu mềm mịn.</p>
                        <p>Đặc biệt các bạn sinh viên, nhân viên văn phòng mang đi đảm bảo có giờ nghỉ trưa siêu thư giãn.</p>
                        <p>Kích thước: 45cm.</p>
                        <p>Có chỗ để ủ ấm tay ở 2 bên.</p>
                        <p>Size chăn: 1m x 1m5.</p>
                    </div>
