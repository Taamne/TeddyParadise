            ...
            <div class="product_page">
                <div class="product_page-introduce">
                    <div class="product_page-intro-item">
                        <img src="./assets/img/product9.png" alt="" class="product_page-intro-img">
                    </div>
                    <div class="product_page-intro-item">
                        ...
                        <h2 class="product_page-intro-header">Bé cừu béo Shaun The Sheep</h2>
                        <div class="intro_line"></div>
                        <p class="product_intro-price">190.000₫</p>
                ...
                <div class="product_page-description">
                    ...
                    <div class="product_page-description-item">
                        <p>MÔ TẢ BÉ CỪU BÉO SHAUN THE SHEEP:</p>
                        <p>Chất liệu: Lông mềm xù kết hợp vải nỉ nhung, bông gòn cao cấp.</p>
                        <p>Kích thước: 40cm.</p>
                        <p>Thích hợp để: Làm đồ chơi, trang trí nhà cửa, quà tặng sinh nhật, quà tặng các dịp lễ,...</p>
                    </div>
